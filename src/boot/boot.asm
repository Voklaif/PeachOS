...
[BITS 32]
load32:
    mov eax, 1          ; Load from sectore 1, because sector 0 is the boot sector
    mov ecx, 100        ; Total number of sectors we want to load
    mov edi, 0x0100000  ; The adress we want to load into. (1MB)
    call ata_lba_read
...
ata_lba_read:
    ...
    mov eax, ebx    ; Restore the backup LDA
    mov dx, 0x1F3
    out dx, al
    ; Finished sending more bits of the LDA
